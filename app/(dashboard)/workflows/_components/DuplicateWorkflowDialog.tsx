...
export default function DuplicateWorkflowDialog({ workflowId, triggerInDropdown = false }: { workflowId: string; triggerInDropdown?: boolean }) {
  ...
  const { mutate, isPending } = useMutation({
    mutationKey: ["duplicate-workflow"],
    mutationFn: async (vars: duplicateWorkflowSchemaType) => {
      return await DuplicateWorkflow(vars);
    },
    onSuccess: () => {
    ...
    onError: (error) => {
      console.error("CLIENT: Duplicate Mutation error:", error);
