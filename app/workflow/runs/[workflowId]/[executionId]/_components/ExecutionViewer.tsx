...
import { Calendar1Icon, CalendarIcon, CircleDashedIcon, ClockIcon, CoinsIcon, CopyIcon, Loader2Icon, LucideIcon, WorkflowIcon } from 'lucide-react';
...
function ExecutionLabel({
    ...
    return (
        <div className='flex justify-between items-center py-2 px-4 text-sm'>
            ...
            <div className='font-semibold capitalize gap-2 items-center'>
                {value}
            </div>
        </div>
    )
